...
public AdminDashboard(Customer[] customers , Photographer[] photographer)
{
  ...
  manageDri = new JButton("Manage Photographer");
...
aDashboardFrame.setTitle("HIRE PHOTOGRAPHER");
...
public void driList(Photographer d ,int gap )
{
...
if(e.getSource() == remove1)
{
  ...
  if(e.getSource() == remove2)
  {
    ...
    for(int i=0; i<photographer.length; i++)
    {
        if(photographer[i] != null)
        {
          if(photographer[i].getName().equals(driDelete))
            {
              photographer[i] = null;
              System.out.println("Photographer" +i+ "removed");
              adminPanel5.removeAll();
              adminPanel4.setVisible(false);
              adminPanel4.setVisible(true);
              break;
    ...
    for(int i=0; i<photographer.length; i++)
    {
        ...
        {
          driList(photographer[i] , i);
          System.out.println(photographer[i].getName());
        }
    }
